...
(function($) {
    $(document).ready(function() {
        // Fetch the data from the HTML attributes
        var chartDataElement = document.getElementById('chartData');
        var currentMonthData = JSON.parse(chartDataElement.getAttribute('data-current-month'));
        var lastMonthData = JSON.parse(chartDataElement.getAttribute('data-last-month'));

        // Prepare the data for the chart
        var chartData = {
            labels: currentMonthData.map(data => data.opening__job__name), // Replace 'jobName' with your actual key
            datasets: [{
                label: "Current Month",
                fill: "start",
                data: currentMonthData.map(data => data.total_applications), // Replace with actual key
                ...
                label: "Last Month",
                fill: "start",
                data: lastMonthData.map(data => data.totalApplications), // Replace with actual key
        ...
        var chartElement = document.getElementsByClassName("blog-overview-users")[0];

        // Initialize the chart
        var blogOverviewUsersChart = new Chart(chartElement, {
            type: 'line', // Change the type as needed: 'line', 'bar', 'pie', etc.
            data: chartData,
            options: chartOptions
        });

        // Other JavaScript code can be added here if needed
    });
})(jQuery);
